...
namespace DateTimeLabTests
{
    ...
    public class DateTimeLabCodeTests
    {
        ...
        [TestCase("04/01/2005", "January 1, 2005")]
        [TestCase("10/20/2005", "April 20, 2005")]
        [TestCase("06/30/2006", "December 30, 2005")]
        ...
        public void GetNextWednesdays2()
        {
            ...
            Assert.AreEqual(actual[2], fourth);

            var fifth = new DateTime(2016, 3, 2);
            Assert.AreEqual(actual[2], fifth);
        }
    }
}
