...
namespace _03_05_01_SystemIO.Helpers
{
    public class ConsoleIO
    {
        ...
        public const string StudentLineFormat = "{0,-20} {1,-15} {2, 5} {3, 5}";
        public const string PickStudentLineFormat = "{0,2} {1,-20} {2,-15} {3, 5} {4, 5}";

        public static void PrintStudentListHeader()
        {
            Console.WriteLine(SeparatorBar);
            Console.WriteLine(StudentLineFormat, "Name", "Major", "GPA", "Credit Hours");
            Console.WriteLine(SeparatorBar);
        }
        ...
        public static string GetRequiredStringFromUser(string prompt)
        {
            while (true)
            {
                ...
                {
                    Console.WriteLine("You must enter text without commas.");
                    Console.WriteLine("Press any key to continue...");
                    Console.ReadKey();
                }
                else
        ...
        public static int GetRequiredIntFromUser(string prompt)
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine("Credit Hours must be between 0 and 1000.");
                        Console.WriteLine("Press any key to continue...");
                        Console.ReadKey();
                        continue;
                    }
        ...
        {
            Console.WriteLine(SeparatorBar);
            Console.WriteLine(PickStudentLineFormat, "", "Name", "Major", "GPA", "Credit Hours");
            Console.WriteLine(SeparatorBar);
