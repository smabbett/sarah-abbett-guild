$(document).ready(function () {
  ...
  $('#edit-dvd-button').click(function(event){
    ...
    $.ajax({
       type: 'PUT',
       url: 'http://localhost:54142/dvd/' + $('#edit-dvd-id').val(),
       data: JSON.stringify({
  ...
  $('#search-button').click(function(event){
    ...
    $.ajax ({
        type: 'GET',
        url: 'http://localhost:54142/dvds/' + choice + '/' + searchTerm,
        success: function (data, status) {
...
function showEditForm(dvdId) {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://localhost:54142/dvd/' + dvdId,
        success: function(data, status) {
